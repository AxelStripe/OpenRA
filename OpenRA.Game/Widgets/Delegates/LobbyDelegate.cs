...
namespace OpenRA.Widgets.Delegates
{
	public class LobbyDelegate : IWidgetDelegate
	{
		...
		public LobbyDelegate()
		{
			...
			colorChooser.GetWidget<ButtonWidget>("BUTTON_OK").OnMouseUp = mi =>
			{
				...
				var d = (ColorChooser)colorChooser.DelegateInstance;
				d.UpdatePlayerColor();
				return true;
			};
		}
	...
	public class ColorChooser : HookingWidgetDelegate
	{
		float hue, saturation, luminance, range;

		[WidgetHook( "SliderChange", "HUE_SLIDER" )]
		public float Hue { get { return hue; } set { hue = value; UpdateColorPreview(); } }
		[WidgetHook( "SliderChange", "SAT_SLIDER" )]
		public float Saturation { get { return saturation; } set { saturation = value; UpdateColorPreview(); } }
		[WidgetHook( "SliderChange", "LUM_SLIDER" )]
		public float Luminance { get { return luminance; } set { luminance = value; UpdateColorPreview(); } }
		[WidgetHook( "SliderChange", "RANGE_SLIDER" )]
		public float Range { get { return range; } set { range = value; UpdateColorPreview(); } }
		...
		public void ColorFromLocalClient()
		{
			Hue = Game.LocalClient.Color1.GetHue() / 360f;
			Saturation = Game.LocalClient.Color1.GetSaturation();
			Luminance = Game.LocalClient.Color1.GetBrightness();
			Range = Game.LocalClient.Color1.GetBrightness() == 0 ? 0 : Game.LocalClient.Color2.GetBrightness() / Game.LocalClient.Color1.GetBrightness();
		...
		{
			CurrentColorPreview1 = ColorFromHSL( hue, saturation, luminance );
			CurrentColorPreview2 = ColorFromHSL( hue, saturation, range * luminance );
			Game.viewport.RefreshPalette();
		}

		public void UpdatePlayerColor()
		{
			Game.Settings.PlayerColor1 = CurrentColorPreview1;
			Game.Settings.PlayerColor2 = CurrentColorPreview2;
			Game.Settings.Save();

			var c1 = CurrentColorPreview1;
			var c2 = CurrentColorPreview2;
			Game.IssueOrder(Order.Command("color {0},{1},{2},{3},{4},{5}".F(c1.R,c1.G,c1.B,c2.R,c2.G,c2.B)));
		}
